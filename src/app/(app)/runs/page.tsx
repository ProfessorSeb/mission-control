    ...
    <div className="space-y-6">
      ...
      <div className="overflow-hidden rounded-md border border-zinc-800">
        <div className="grid grid-cols-12 gap-2 border-b border-zinc-800 bg-zinc-900/50 px-3 py-2 text-xs font-medium text-zinc-300">
          ...
          <div className="col-span-2">Mode/Model</div>
      ...
      <div className="text-xs text-zinc-500">
        <div>
          Tip: set <span className="font-mono">OPENCLAW_HOME</span> if you run this
          dashboard somewhere other than the OpenClaw host.
        </div>
      </div>
    </div>
  );
